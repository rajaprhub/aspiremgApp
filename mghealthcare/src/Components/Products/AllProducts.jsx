  ...
  return (
     ...
     {/* ---------------- */}
      ...
      <span className={styles.discount}> 
       <span>MRP</span><span><FontAwesomeIcon className={styles.rupee} 
       icon={faIndianRupeeSign}/>{el.mrp}</span><span>{el.discount}%</span><span>OFF</span>
       </span>

      <div className={styles.price}>
      <span><FontAwesomeIcon style={{fontSize:"15px",color:"rgb(107, 106, 106)"}} 
       icon={faIndianRupeeSign}/> {el.price}</span> <span>ADD</span>
        </div>
